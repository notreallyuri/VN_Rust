use novn::input::navigation::InputDevice;
use novn::input::pad::{PadButton, PadFamily};
use novn::input::prompts::{Prompt, Prompts};
...
fn cursor_files_live_under_ui_unless_a_folder_is_named() {
    assert_eq!(novn::ui::cursor::path("arrow.png"), "ui/arrow.png");
    assert_eq!(novn::ui::cursor::path("art/Arrow.PNG"), "art/arrow.png");
}
...
fn nintendo_labels_follow_the_button_in_the_same_place() {
    let labels = novn::input::pad::PadLabels::default();
    assert_eq!(
