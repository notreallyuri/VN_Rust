...
scene reports_start:
  background field_post with fade
  music santa_ilde
  ...
  show house_envoy neutral at center with dissolve
  ...
  remove house_envoy with dissolve
...
scene reports_the_shadows:
  ...
  show shadow_third neutral at right with slide_left
...
scene reports_blessing:
  background field_post with dissolve
  music santa_ilde
